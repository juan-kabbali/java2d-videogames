...
public class FlechaDorada extends Flecha {
    
    Random dorado;
    
    /**
     * Constructor que se encarga de cargar las imagenes de las flechas doradas y crear el random*/
    public FlechaDorada(Point p) {
        super(p);
        cargarImagenes();
        dorado = new Random();
        cargarImagenes();
        imb = dorado.nextInt(4);
    }

    /**
      *pinta las flechas doradas  @param d recibe una grafica para dibujar
     */
    @Override
    ...
    public void cargarImagenes() {
        ...
        try {
            a1 = ImageIO.read(new File("FD izquierda.png"));
            a2 = ImageIO.read(new File("FD abajo.png"));
            a3 = ImageIO.read(new File("FD arriba.png"));
            a4 = ImageIO.read(new File("FD derecha.png"));
