 ...
 * @version 1.0
 */
public class ObjetoDeValor extends Objeto {
    ...
    public void cargarImagenes() {
        ...
        try {
            a1 = ImageIO.read(new File("Diamante.png"));
            a2 = ImageIO.read(new File("Esmeralda.png"));
            a3 = ImageIO.read(new File("Billete.png"));
            a4 = ImageIO.read(new File("Moneda.png"));
